...
class OlindaRDataset(Dataset):
    ...
    def __getitem__(self: "OlindaRDataset", index: int) -> Any:
...
class OlindaRDataModule(pl.LightningDataModule):
    """Olinda Regression data module."""
    ...
    def prepare_data(self: "OlindaRDataModule") -> None:
        """Prepare data."""
        # download, split, etc...
        # only called on 1 GPU/TPU in distributed
        pass

    def setup(self: "OlindaRDataModule", stage: Optional[str]) -> None:
        """Setup dataloaders.

        Args:
            stage (Optional[str]): Optional pipeline state
        """
        self.dataset = OlindaRDataset(
            self.csv_path,
            self.transform,
    ...
    def train_dataloader(self: "OlindaRDataModule") -> DataLoader:
        """Train dataloader.
    ...
    def enc_train_dataloader(
        self: "OlindaRDataModule", context: ts.Context
    ) -> DataLoader:
    ...
    def val_dataloader(self: "OlindaRDataModule") -> DataLoader:
        """Val dataloader.
    ...
    def test_dataloader(self: "OlindaRDataModule") -> DataLoader:
        """Test data loader.
    ...
    def predict_dataloader(self: "OlindaRDataModule") -> DataLoader:
        """Predict data loader.
    ...
    def teardown(self: "OlindaRDataModule", stage: Optional[str] = None) -> None:
